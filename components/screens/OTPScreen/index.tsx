          ...
          {!showPasswordForm ? (
            <View style={styles.form}>
              ...
              <TouchableOpacity
                ...
                accessibilityHint={loading ? "Verifying code" : "Double tap to verify your 6-digit code"}
            ...
            <View style={styles.form}>
              ...
              <TouchableOpacity
                ...
                accessibilityHint={loading ? "Updating password" : "Double tap to save your new password"}
                accessibilityState={{ disabled: loading, busy: loading }}
              >
                {loading ? (
                  <ActivityIndicator color="white" />
