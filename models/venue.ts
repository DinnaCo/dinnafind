...
/**
 * A venue/place from Google Places API
 */
...
/**
 * Standardized venue details (used by venue details service)
 * This is essentially the same as Venue, just with required id and fsq_id
 */
export interface StandardizedVenueDetails extends Omit<Venue, 'id' | 'fsq_id'> {
  id: string;
  fsq_id: string;
  iconUrl?: string;
}
